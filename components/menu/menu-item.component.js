...
var MenuItemComponent = (function () {
    function MenuItemComponent(menu, hostRef, cdRef) {
        this.menu = menu;
    ...
    MenuItemComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        this.initMenu();
        this.subMenus.changes.subscribe(function () {
            _this.initMenu();
        });
    };
    MenuItemComponent.prototype.initMenu = function () {
        this.subMenu = null;
    ...
    MenuItemComponent.prototype.onClickItem = function (event) {
    ...
    MenuItemComponent.prototype.highlight = function () {
        this.parentMenu.subItems.forEach(function (item) {
            item.unhighlight();
        });
        this.isActived = true;
        if (this.subMenu) {
    ...
    MenuItemComponent.prototype.unhighlight = function () {
        if (this.subMenu) {
...
MenuItemComponent.propDecorators = {
    ...
    'subMenus': [{ type: ContentChildren, args: [forwardRef(function () { return SubMenuComponent; }),] },],
    'value': [{ type: Input },],
    'text': [{ type: Input },],
    'iconCls': [{ type: Input },],
    'disabled': [{ type: Input },],
