 ...
 *
 */
import { Component, ContentChildren, forwardRef, Input, ElementRef, Host, Inject } from '@angular/core';
import { MenuComponent } from './menu.component';
import { MenuItemComponent } from './menu-item.component';
import { domHelper } from '../base/domhelper';
var SubMenuComponent = (function () {
    function SubMenuComponent(menu, hostRef) {
        this.menu = menu;
    ...
    SubMenuComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
    ...
    SubMenuComponent.prototype.initItems = function () {
        var _this = this;
        this.subItems.forEach(function (item) {
            item.parentMenu = _this;
        });
    };
    SubMenuComponent.prototype.unhighlight = function () {
        this.subItems.forEach(function (item) {
            item.unhighlight();
        });
    };
    SubMenuComponent.prototype.alignMenu = function () {
        this.zIndex = MenuComponent.zIndex++;
        var view = domHelper.getViewport();
        var pos = domHelper.offset(this.parentItem.hostRef.nativeElement);
        var width = domHelper.outerWidth(this.hostRef.nativeElement);
        var height = domHelper.outerHeight(this.hostRef.nativeElement);
        var pwidth = domHelper.outerWidth(this.parentItem.hostRef.nativeElement);
        var left = pwidth - 1;
...
SubMenuComponent.ctorParameters = function () { return [
    { type: MenuComponent, decorators: [{ type: Host }, { type: Inject, args: [forwardRef(function () { return MenuComponent; }),] },] },
    { type: ElementRef, },
]; };
